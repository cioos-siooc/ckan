...
COPY ./contrib/docker/src/ckanext-dictionary $CKAN_VENV/src/ckanext-dictionary
...
RUN /bin/bash -c "source $CKAN_VENV/bin/activate && cd $CKAN_VENV/src/ckanext-dictionary && python setup.py install && python setup.py develop"
